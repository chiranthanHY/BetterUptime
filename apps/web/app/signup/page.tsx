        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 selection:bg-blue-500 selection:text-white">
            ...
            <div className="w-full max-w-md z-10 space-y-8">
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-center">Start monitoring in minutes</h1>
                    <p className="text-white/60 text-center">Join 10,000+ teams using BetterUptime</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-white/70" htmlFor="email">Work email</label>
                            <input
                                id="email"
                                type="email"
                                required
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-xs text-white/50">
                            <Check className="text-emerald-500" size={14} />
                            <span>Unlimited status pages & SSL monitoring</span>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-black/50 px-2 text-white/40 backdrop-blur-sm">Or sign up with</span>
                        </div>
                    </div>
