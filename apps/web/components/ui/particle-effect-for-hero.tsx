    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-20 flex justify-between items-center p-6 md:p-8">
            <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-medium tracking-wide text-lg underline decoration-blue-500/50 underline-offset-4">BetterUptime</span>
            </div>
            <div className="hidden md:flex space-x-8 text-sm font-medium text-white/70">
                <a href="/dashboard" className="text-white font-bold">Dashboard</a>
            ...
            <div className="flex items-center space-x-4">
                <a href="/signin" className="text-sm font-medium text-white/70 hover:text-white transition-colors">Sign In</a>
                <a href="/signup" className="px-4 py-2 bg-white text-black text-sm font-bold rounded-full hover:bg-white/90 transition-all active:scale-95">Sign Up</a>
            </div>
        </nav>
    )
}
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-4">
            <div className="max-w-4xl w-full text-center space-y-8">
                ...
                <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/60 font-light leading-relaxed">
                    The world's most beautiful monitoring tool. Intelligent alerting, status pages, and incident management for modern teams.
                </p>

                <div className="pt-8 pointer-events-auto">
                    <a href="/signup" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full font-bold tracking-wide overflow-hidden transition-transform hover:scale-105 active:scale-95">
